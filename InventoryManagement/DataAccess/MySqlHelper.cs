...
namespace InventoryManagement.DataAccess
{
    ...
    {
        private const int C_INT_BATCHUPDATE_COUNT = 25;
        ...
        private static void AttachParameters(MySqlCommand command, MySqlParameter[] commandParameters, bool sanitizeParameters)
        {
            try
            {
                    ...
                    foreach (MySqlParameter p in commandParameters)
                    {
                        if (p != null)
                        {
                                ...
                                p.Direction == ParameterDirection.Input))
                            {
                                ...
                                else if (sanitizeParameters && string.IsNullOrEmpty(p.SourceColumn))
                                    SanitizeInput(p);
                            }
            ...
            {
                //LogManager.Trace("AttachParameters", e, null);
                throw new MPTException(e);
            }
        ...
        private static void SanitizeInput(MySqlParameter inputParameter)
        {
            ...
            //      It is strongly recomended to use parameterized sp instead of having dynamic query.
            var value = inputParameter.Value.ToString();

            if ((value.Contains("'")) && (inputParameter.MySqlDbType == MySqlDbType.VarChar || inputParameter.MySqlDbType == MySqlDbType.Text))
            {
                if (value.ToLower().Contains("and") || value.ToLower().Contains("or") || value.ToLower().Contains("like"))
                {
                    ...
                    inputParameter.Value = string.Join(string.Empty, values);
                }
                else
                {
                    inputParameter.Value = inputParameter.Value.ToString().Replace("''", "'").Replace("'", "''");
                }
            }
        }
        ...
        /*private static void AssignParameterValues(MySqlParameter[] commandParameters, DataRow dataRow)
		{
			...
			{
				//LogManager.Trace("AssignParameterValues",e,null);
				throw new MPTException(e);
			}
			catch(Exception e)
			{
        ...
        */
        ...
        private static void PrepareCommand(MySqlCommand command, MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, MySqlParameter[] commandParameters, out bool mustCloseConnection)
        {
            try
            {
                ...
                AttachParameters(command, commandParameters, command.CommandType == CommandType.StoredProcedure && (command.CommandText.EndsWith("_q") || command.CommandText.Contains("_q_")));
            ...
            /*catch (ArgumentNullException e)
			{
				//LogManager.Trace("PrepareCommand",e,null);
				throw new MPTException(e);
			}	
			catch(SqlException e)
			{
        ...
        public static int ExecuteNonQuery(string connectionString, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
        {
            ...
            {
                //LogManager.Trace("SQLHelper::ExecuteNonQuery() :: ", e, " SQL String is :: ", commandText);
                throw e;
            }
            /*catch (ArgumentNullException e)
			{
                //LogManager.Trace("SQLHelper::ExecuteNonQuery() :: ", e, " SQL String is :: ", commandText);
				//LogManager.Trace("ExecuteNonQuery",e,null);
				throw new MPTException(e);
			}	
			catch(SqlException e)
			{
        ...
        public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            {
                //LogManager.Trace("SQLHelper::ExecuteNonQuery() :: ", e, " SQL spName Name is :: ", spName);
                throw e;
            }
            /*catch (ArgumentNullException e)
			{
                //LogManager.Trace("SQLHelper::ExecuteNonQuery() :: ", e, " SQL SP Name is :: ", spName);
				//LogManager.Trace("ExecuteNonQuery",e,null);
				throw new MPTException(e);
			}	
			catch(SqlException e)
        ...
        public static int ExecuteNonQuery(MySqlConnection connection, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
        {
            ...
            /*catch (ArgumentNullException e)
			{
                //LogManager.Trace("SQLHelper::ExecuteNonQuery() :: ", e, " SQL commandText Name is :: ", commandText);
				//LogManager.Trace("ExecuteNonQuery",e,null);
				throw new MPTException(e);
			}	
			catch(SqlException e)
        ...
        /*public static DataSet ExecuteDataset(string connectionString, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
		{
			...
			{
                //LogManager.Trace("SQLHelper::ExecuteDataset() :: ", e, " SQL commandText Name is :: ", commandText);
				throw e;
			}
            catch (ArgumentNullException e)
			{
        ...
        /*public static DataSet ExecuteDataset(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            {
                //LogManager.Trace("SQLHelper::ExecuteDataset() :: ", e, " SQL spName Name is :: ", spName);
                throw e;
            }
            catch (ArgumentNullException e)
            {
        ...
        */
        ...
        /*public static DataSet ExecuteDataset(MySqlConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                //LogManager.Trace("SQLHelper::ExecuteDataset() :: ", e, " SQL spName Name is :: ", spName);
                //LogManager.Trace("ExecuteDataset", e, null);
                throw new MPTException(e);
            }	
            catch(SqlException e)
            {
        ...
        */
        ...
        public static MySqlDataReader ExecuteReader(string connectionString, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
        {
            ...
            /*catch (ArgumentNullException e)
			{
				...
				//LogManager.Trace("ExecuteReader",e,null);
				throw new MPTException(e);
			}	
			catch(SqlException e)
			{
        ...
        public static object ExecuteScalar(string connectionString, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
        {
            ...
            /*catch (ArgumentNullException e)
			{
				//LogManager.Trace("ExecuteScalar",e,null);
				throw new MPTException(e);
			}	
			catch(SqlException e)
			{
        ...
        public static MySqlCommand CreateCommand(MySqlConnection connection, string spName, params string[] sourceColumns)
        {
            try
            {
                ...
                if ((sourceColumns != null) && (sourceColumns.Length > 0))
                {
                    ...
                    AttachParameters(cmd, commandParameters, false);
                }
                return cmd;
            }
            catch (Exception e)
            ...
            /*catch (ArgumentNullException e)
			{
				//LogManager.Trace("CreateCommand",e,null);
				throw new MPTException(e);
			}	
			catch(SqlException e)
			{
        ...
        #region BatchUpdate
        public static bool BatchUpdate(string[] arrSqls, string strConn, bool bLogSqls)
        {
            bool bResult = false;
            ...
            try
            {
                ...
                objConn.Open();
                bResult = InternalBatchUpdate(arrSqls, objConn, bLogSqls);
            }
            catch (Exception e)
            {
                bResult = false;
                //LogManager.Trace("BatchUpdate",e,null);
            }
            finally
            {
        ...
        public static bool BatchUpdate(string[] arrSqls, MySqlConnection objConn, bool bLogSqls)
        {
            return InternalBatchUpdate(arrSqls, objConn, bLogSqls);
        }

        public static bool BatchUpdate(string[] arrSqls, MySqlTransaction objTrans, bool bLogSqls)
        {
            if (objTrans == null) throw new ArgumentNullException("transaction");
            if (objTrans != null && objTrans.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");

            return InternalBatchUpdate(arrSqls, objTrans, bLogSqls);
        }
        //ramesh add for overload stingcollection with string connectin
        public static bool BatchUpdate(List<string> arrSqls, string strConn, bool bLogSqls)
        {
            bool bResult = false;
            MySqlConnection objConn = null;
            try
        ...
        public static bool BatchUpdate(List<string> arrSqls, MySqlTransaction objTrans, bool bLogSqls)
        {
            if (objTrans == null) throw new ArgumentNullException("transaction");
            if (objTrans != null && objTrans.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");

            return InternalBatchUpdate(arrSqls, objTrans, bLogSqls, C_INT_BATCHUPDATE_COUNT);
        }



        public static bool BatchUpdate(List<string> arrSqls, MySqlTransaction objTrans, bool bLogSqls, int batchcount)
        {
            if (objTrans == null) throw new ArgumentNullException("transaction");
            if (objTrans != null && objTrans.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (batchcount < C_INT_BATCHUPDATE_COUNT)
            {
                batchcount = C_INT_BATCHUPDATE_COUNT;
            }
            return InternalBatchUpdate(arrSqls, objTrans, bLogSqls, batchcount);
        }
        public static bool BatchUpdateWithoutTrans(string strconn, List<string> arrSqls, bool bLogSqls, int batchcount)
        {
            bool bResult = false;
            MySqlConnection objConn = null;
            try
            {
                objConn = new MySqlConnection(strconn);
                objConn.Open();
                bResult = InternalBatchUpdateWithoutTrans(objConn, arrSqls, bLogSqls, batchcount);
            }
            catch (Exception e)
            {
                bResult = false;
                //LogManager.Trace("BatchUpdateWithoutTrans", e, null);
            }
            finally
            {
                if ((objConn != null) && (objConn.State == ConnectionState.Open))
        ...
        private static bool InternalBatchUpdate(List<string> arrSqls, MySqlTransaction objTrans, bool bLogSqls, int batchcount)
        {
            bool bResult = false;
            ...
            try
            {
                int nCount = arrSqls.Count;
                int nNumBatches = nCount / batchcount;
                if ((nCount % batchcount) == 0)
                {
                    nNumBatches = nCount / batchcount;
                }
                else
                {
                    nNumBatches = (nCount / batchcount) + 1;
                }

                string[] arrFinalSqls = new string[nNumBatches];

                string strTemp = string.Empty;
                int nCurrentItemCnt = 0;
                strTemp = "sp_executesql  N' ";
                bool bFinalLeft = false;
                int nCurrentBatch = 0;
                for (int nLoopIdx = 0; nLoopIdx < nCount; nLoopIdx++)
                {
                    if ((arrSqls[nLoopIdx] != null) && (arrSqls[nLoopIdx] != string.Empty))
                    {
                        if (nCurrentItemCnt == batchcount)
                        {
                            if (arrSqls[nLoopIdx] != string.Empty)
                            {
                                strTemp += arrSqls[nLoopIdx];
                                strTemp += ";";
                                strTemp += "'";
                                nCurrentItemCnt = 0;
                                arrFinalSqls[nCurrentBatch++] = strTemp;
                                strTemp = "sp_executesql  N' ";
                                bFinalLeft = false;
                            }
                        }
                ...
                if (nCount > 0)
                {
                    ...
                    for (int nLoopIdx = 0; nLoopIdx < nCount; nLoopIdx++)
                    {
                        strTemp = arrFinalSqls[nLoopIdx];
                        if ((strTemp != null) && (strTemp != string.Empty))
                        {
                            if (bLogSqls == true)
                            {
                                //LogManager.Trace("BatchUpdate",TraceCategoryType.Information,"SQL:"+nLoopIdx.ToString(),strTemp);
                            }
                            ExecuteNonQuery(objTrans, CommandType.Text, strTemp);
            ...
            {
                //Transaction commiting or rollback is not required here,
                //since the transaction has been opened by the caller method
                //So that wil be responsable to commit or rollback the transaction - Himadri
                //				if(objTrans != null)
                //				{
                //					if(bTransStarted == true)
                //					{
                //						if(bResult == true)
                //						{
                //							objTrans.Commit();
        ...
        private static bool InternalBatchUpdate(List<string> arrSqls, MySqlConnection objConn, bool bLogSqls)
        {
            bool bResult = false;
            ...
            try
            {
                ...
                bResult = InternalBatchUpdate(arrSqls, objTrans, bLogSqls, C_INT_BATCHUPDATE_COUNT);
            }
            catch (Exception e)
            {
                //LogManager.Trace("BatchUpdate", e, null);
        ...
        private static bool InternalBatchUpdate(string[] arrSqls, MySqlConnection objConn, bool bLogSqls)
        {
            bool bResult = false;
            MySqlTransaction objTrans = null;
            bool bTransStarted = false;
            try
            {
                ...
                bResult = InternalBatchUpdate(arrSqls, objTrans, bLogSqls);
            }
            catch (Exception e)
            {
                //LogManager.Trace("BatchUpdate",e,null);
        ...
        private static bool InternalBatchUpdate(string[] arrSqls, MySqlTransaction objTrans, bool bLogSqls)
        {
            bool bResult = false;
            //bool bTransStarted = false;
            ...
            try
            {
                int nCount = arrSqls.Length;
                int nNumBatches = nCount / C_INT_BATCHUPDATE_COUNT;
                if ((nCount % C_INT_BATCHUPDATE_COUNT) == 0)
                {
                    nNumBatches = nCount / C_INT_BATCHUPDATE_COUNT;
                }
                else
                {
                    nNumBatches = (nCount / C_INT_BATCHUPDATE_COUNT) + 1;
                }
                ...
                for (int nLoopIdx = 0; nLoopIdx < nCount; nLoopIdx++)
                {
                    if ((arrSqls[nLoopIdx] != null) && (arrSqls[nLoopIdx] != string.Empty))
                    {
                        if (nCurrentItemCnt == C_INT_BATCHUPDATE_COUNT)
                        {
                            if (arrSqls[nLoopIdx] != string.Empty)
                            {
                                strTemp += arrSqls[nLoopIdx];
        ...
        private static bool InternalBatchUpdateWithoutTrans(MySqlConnection objConn, List<string> arrSqls, bool bLogSqls, int batchcount)
        {
            bool bResult = false;
                ...
                if (nCount > 0)
                {
                    ...
                    for (int nLoopIdx = 0; nLoopIdx < nCount; nLoopIdx++)
                    {
                        ...
                        if ((strTemp != null) && (strTemp != string.Empty))
                        {
                            if (bLogSqls == true)
                            {
                                //LogManager.Trace("InternalBatchUpdateWithoutTrans", TraceCategoryType.Information, "SQL:" + nLoopIdx.ToString(), strTemp);
                            }
                            ExecuteNonQuery(objConn, CommandType.Text, strTemp);
            ...
            {
                //LogManager.Trace("InternalBatchUpdateWithoutTrans", e, null);
                bResult = false;
                throw e;
            }
            /*catch (ArgumentNullException e)
    ...
    public sealed class SqlHelperParameterCache
    {
        ...
        private static MySqlParameter[] DiscoverSpParameterSet(MySqlConnection connection, string spName, bool includeReturnValueParameter)
        {
            ...
            {
                //LogManager.Trace("DiscoverSpParameterSet",e,null);
                throw e;
            }
            /*catch (ArgumentNullException e)
			{
        ...
        private static MySqlParameter[] CloneParameters(MySqlParameter[] originalParameters)
        {
            ...
            {
                clonedParameters[i] = (MySqlParameter)(originalParameters[i]).Clone();
            }
        ...
        public static MySqlParameter[] GetCachedParameterSet(string connectionString, string commandText)
        {
            ...
            {
                //LogManager.Trace("GetCachedParameterSet",e,null);
                throw e;
            }
            /*catch (ArgumentNullException e)
			{
        ...
        {
            if (connection == null) throw new ArgumentNullException("connection");
            using (MySqlConnection clonedConnection = (MySqlConnection)(connection.Clone()))
            {
        ...
        private static MySqlParameter[] GetSpParameterSetInternal(MySqlConnection connection, string spName, bool includeReturnValueParameter)
        {
            ...
            {
                //LogManager.Trace("GetSpParameterSetInternal",e,null);
                throw e;
            }
            /*catch (ArgumentNullException e)
			{
...
//replaced StringCollection with List<string>
//replaced SqlParameter with MySqlParameter
//replaced 
//replaced 
//replaced 
//replaced 
